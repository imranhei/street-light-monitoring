            ...
            <div className="h-fit w-96 rounded overflow-hidden shadow-md flex justify-center flex-col items-center py-10 gap-4  bg-white">
                ...
                <div className="w-80 flex flex-col gap-2">
                    <div className="flex w-full gap-2">
                        <h1 className='w-24'>Name<span className='text-red-400'> *</span> :</h1>
                    ...
                    <div className="flex w-full gap-2">
                        <h1 className='w-24'>Email<span className='text-red-400'> *</span> :</h1>
                    ...
                    <div className="flex w-full gap-2">
                        <h1 className='w-24'>Password <span className='text-red-400'>*</span> :</h1>
                        <input onChange={e => setPassword(e.target.value)} type="password" className='bg-transparent border-b border-gray-300 focus:border-teal-400 px-1 flex-1 outline-none'/>
                    </div>
                    <h1 className="text-xs text-red-400">{errors.password}</h1>
                    <div className="flex w-full gap-2">
                        <h1 className='w-24'>Confirm password <span className='text-red-400'>*</span> :</h1>
                        <input onChange={e => setConPassword(e.target.value)} type="password" className='bg-transparent border-b border-gray-300 focus:border-teal-400 px-1 flex-1 outline-none'/>
                    </div>
                    <h1 className="text-xs text-red-400">{errors.password}</h1>
                    <div className="flex w-full gap-2">
                        <label className='w-24' htmlFor="role">Select Role<span className='text-red-400'>*</span>:</label>
                        <select className='border outline-none' id="role" value={selectedRole} onChange={handleRoleChange}>
