...
export default function TotalLights() {
  return (
    <div className='w-1/3 bg-pink-400 p-4 rounded-sm shadow-lg flex flex-col gap-5 items-center justify-center m-2 h-56'>
      <h1 className='text-white font-bold lg:text-2xl text-center'>Total Number of Lights: 1000</h1>
