        ...
        <div className='w-72 h-[450px] bg-white flex flex-col gap-1 items-center justify-center'>
          ...
          <div className='w-60 text-sm'>
            ...
            <div className='border-b-2 pb-1 flex items-center focus-within:border-teal-400'>
              ...
              <input onChange={e => setUsername(e.target.value)} className='outline-none w-full pl-1' type='text' placeholder='Type your username'/>
            </div>
            ...
            <div className='border-b-2 pb-1 flex items-center focus-within:border-teal-400'>
              ...
              <input onChange={e => setPass(e.target.value)} className='outline-none w-full pl-1' type='password' placeholder='Type your username'/>
            </div>
